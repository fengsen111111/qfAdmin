...
export const APPConfig = {
    appPageComponentsFolder: 'factory5',
    // apiURL: 'http://127.0.0.1',
    apiURL: 'https://factory.api.sczhiyun.net',
    WebSocketURL: 'wss://factory.api.sczhiyun.net/wss',
    RSA: false,
...
import DemoPage from '@/components/app_page_components/factory5/demo.vue' //项目个性化页面

export const allPageComponents = {
    TablePage, FormPage, DetailPage, CustomerPage, IndexPage, DemoPage
}
