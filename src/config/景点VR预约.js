...
export const APPConfig = {
    appPageComponentsFolder: 'attractions_order',
...
import IndexPage from '@/components/app_page_components/attractions_order/index.vue'
import QuestionnairePage from '@/components/app_page_components/attractions_order/questionnaire.vue'

export const allPageComponents = {
    TablePage, FormPage, DetailPage, CustomerPage, IndexPage, QuestionnairePage
}
