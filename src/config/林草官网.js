...
export const APPConfig = {
    appPageComponentsFolder: 'lin_cao',
    apiURL: 'https://api.lslcky.org.cn',
    WebSocketURL: '',
    RSA: false,
...
import IndexPage from '@/components/base_page_components/index.vue'

export const allPageComponents = {
    TablePage, FormPage, IndexPage
}
