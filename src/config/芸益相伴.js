...
export const APPConfig = {
    appPageComponentsFolder: 'accompany',
    apiURL: 'https://accompany.api.krifation.com',
    RSA: false,
...
import IndexPage from '@/components/app_page_components/accompany/index.vue' //项目首页，可以采用通用也可以使用个性化
