<script setup>
  ...
  import { AuditOutlined, ContainerOutlined } from "@ant-design/icons-vue";
...
<template>
  <div>
    ...
    <div v-if="type=='平台'">
      <div style="display: flex;">
        <div style="width: 75%;overflow: auto;height: 86vh;">
        ...
        <!-- right -->
        <div style="background-color: #f5f5f5;width: 23%;padding: 10px;overflow: auto;height: 86vh;">
          <div style="padding: 20px;background-color: #fff;">
            ...
            <div style="display: grid;grid-template-columns: repeat(3, minmax(0, 1fr));">
              <div style="text-align: center;margin-top: 20px;" v-for="item in [1,2,3,4,5,6]" :key="item">
                <span style="background-color: #f5f6f7;border-radius: 4px;padding: 10px;">
                  <ContainerOutlined style="font-size: 20px;" />
                </span>
            ...
            <div style="display: grid;grid-template-columns: repeat(3, minmax(0, 1fr));">
              <div style="text-align: center;margin-top: 20px;" v-for="item in [1,2,3]" :key="item">
                <span style="background-color: #f5f6f7;border-radius: 4px;padding: 10px;">
                  <ContainerOutlined style="font-size: 20px;" />
                </span>
                <div style="margin-top: 10px;">运营管理</div>
